...
export const responses = {
  ...
  loginNonce: {
    ...
    payload:
      'You’re now signing into Buckmint, make sure the origin is https://app.buckmint.org (Login-code:fdsfadf)',
  },
  login: {
    status: 'success',
      ...
      results: [
        {
          ...
          buckmint_deposit_status: 'Pending',
        ...
        },
        {
          ...
          buckmint_deposit_status: 'Success',
          deposit_blockchain_hash:
  ...
  listPolygonDeposits: {
    ...
    payload: {
      count: 23,
      next: 'http://api-testnet.buckmint.fi/sapi/v1/deposits/?limit=1&network=POLYGON&page=3',
      previous:
        'http://api-testnet.buckmint.fi/sapi/v1/deposits/?limit=1&network=POLYGON',
      results: [
        {
          token_id:
  ...
  listWithdrawalsResponse: {
    ...
    payload: {
      count: 315,
      next: 'http://api-testnet.buckmint.fi/main/payment/withdrawals/?page=2',
      previous: null,
      results: [
        {
          id: 7817,
  ...
  listFastWithdrawalsResponse: {
    ...
    payload: {
      count: 72,
      next: 'http://api-testnet.buckmint.fi/main/payment/fast-withdrawals/?page=2',
      previous: null,
      results: [
        {
          id: 1070,
